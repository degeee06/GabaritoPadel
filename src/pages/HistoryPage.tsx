          ...
          {matches.map((match, index) => (
            ...
            >
              ...
              <button 
                ...
                className="absolute top-1/2 right-2 -translate-y-1/2 p-2 rounded-full bg-zinc-800 text-zinc-400 hover:bg-red-900/50 hover:text-red-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity z-10 shadow-sm border border-zinc-700"
